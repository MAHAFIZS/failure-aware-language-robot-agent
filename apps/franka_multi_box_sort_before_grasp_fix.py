...
sorting_items = [
    {
        ...
        "start": np.array([0.35, 0.28, CUBE_Z]),
        "target": np.array([-0.35, 0.30, CUBE_Z]),
    },
    {
        "label": "green",
        "color": np.array([0.0, 1.0, 0.0]),
        "start": np.array([0.48, 0.05, CUBE_Z]),
        "target": np.array([-0.35, 0.00, CUBE_Z]),
    },
    {
        "label": "blue",
        "color": np.array([0.0, 0.2, 1.0]),
        "start": np.array([0.35, -0.25, CUBE_Z]),
        "target": np.array([-0.35, -0.30, CUBE_Z]),
    },
]
