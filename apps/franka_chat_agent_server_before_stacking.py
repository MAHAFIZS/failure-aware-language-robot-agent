...
def validate_plan(plan: dict[str, Any]) -> list[str]:
    ...
    for first_index in range(len(targets)):
        for second_index in range(
            ...
            first_x, first_y = targets[first_index]
            second_x, second_y = targets[second_index]
            ...
            if distance + 1e-6 < MIN_TARGET_SPACING:
                errors.append(
...
def complete_command(success: bool) -> None:
