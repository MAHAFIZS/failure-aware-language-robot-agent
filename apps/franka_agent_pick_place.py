...
while simulation_app.is_running():
    ...
    if controller.is_done():
        ...
        if success:
            ...
            # Reinspect the reference object because it may
            # have moved during physical interaction.
            reference_position = np.asarray(
                reference_cube.get_local_pose()[0],
                dtype=float,
            )
            ...
            # Alternate small corrections around the target.
            if attempt_index == 1:
                target_position[0] += RECOVERY_OFFSET_M
            elif attempt_index == 2:
                target_position[1] -= RECOVERY_OFFSET_M
