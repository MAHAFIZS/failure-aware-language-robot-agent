...
def parse_step(text: str) -> dict:
    ...
    if (
        "sort" in lower
        or "organize" in lower
        or "organise" in lower
        or "categorize" in lower
        or "separate by color" in lower
        or "matching bins" in lower
        or "matching trays" in lower
        or "corresponding bin" in lower
        or "corresponding tray" in lower
    ):
        return {
            "skill": "sort_all",
            "parameters": {},
    ...
    if (
        ...
        or "stack using every" in lower
        or "vertical stack" in lower
        or "stack the colored" in lower
        or "pile all" in lower
        or "pile every" in lower
    ):
        return {
            "skill": "make_tower",
            "parameters": {
